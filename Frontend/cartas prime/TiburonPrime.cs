...
public partial class TiburonPrime : Area2D
{
	...
	[Export] public int vidaActual = 300;
	[Export] public int vidaMaxima = 300;
	[Export] public int escudoActual = 200;
	[Export] public int escudoMaximo = 200;
	[Export] public int puntosAtaque = 230;
