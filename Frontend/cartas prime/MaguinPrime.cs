...
public partial class MaguinPrime : Area2D
{
	...
	[Export] public int vidaActual = 200;
	[Export] public int vidaMaxima = 200;
	[Export] public int escudoActual = 220;
	[Export] public int escudoMaximo = 220;
	[Export] public int puntosAtaque = 250;
