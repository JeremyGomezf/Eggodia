...
public partial class PeonPrime : Area2D
{
	...
	[Export] public int vidaActual = 150;
	[Export] public int vidaMaxima = 150;
	[Export] public int escudoActual = 150;
	[Export] public int escudoMaximo = 150;
	[Export] public int puntosAtaque = 100;
